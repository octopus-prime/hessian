...
const object_t fixture_object::object_1 = map_list_of<string_t, int_t>(L"_value", 0);
const list_t fixture_object::object_2 = list_of<object_t>(object_1)(map_list_of<string_t, int_t>(L"_value", 1));
...
const std::string fixture_object::hessian_0 = std::string("C""\x00""\x90""\x60", 4);
const std::string fixture_object::hessian_1 = std::string("C""\x00""\x91""\x06""_value""\x60""\x90", 12);
const std::string fixture_object::hessian_2 = std::string("\x7a""C""\x00""\x91""\x06""_value""\x60""\x90""\x60""\x91", 15);
const std::string fixture_object::hessian_2a = std::string("\x7a""C""\x00""\x91""\x06""_value""\x60""\x90""Q""\x91", 15);
const std::string fixture_object::hessian_2b = std::string("\x7a""C""\x00""\x91""\x06""_value""\x60""\x90""\x60""\x90", 15);
const std::string fixture_object::hessian_16 = std::string
(
	"X""\xa1"
	"C""\x00""\x90""\x60"
	"C""\x00""\x90""\x61"
