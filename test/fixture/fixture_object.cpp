...
const string_t fixture_object::hessian_0 = string_t("C""\x00""\x90""\x60", 4);
const string_t fixture_object::hessian_1 = string_t("C""\x00""\x91""\x06""_value""\x60""\x90", 12);
const string_t fixture_object::hessian_2 = string_t("\x7a""C""\x00""\x91""\x06""_value""\x60""\x90""\x60""\x91", 15);
const string_t fixture_object::hessian_2a = string_t("\x7a""C""\x00""\x91""\x06""_value""\x60""\x90""Q""\x91", 15);
const string_t fixture_object::hessian_2b = string_t("\x7a""C""\x00""\x91""\x06""_value""\x60""\x90""\x60""\x90", 15);
const string_t fixture_object::hessian_16 = string_t
(
	"X""\xa1"
	"C""\x00""\x90""\x60"
