...
const string_t fixture_fault::hessian_0 = string_t("HZ", 2);
const string_t fixture_fault::hessian_1 = string_t("H""\x04""code""\x97""\x07""message""\x0f""This is a fault""Z", 32);
